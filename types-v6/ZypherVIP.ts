...
export interface ZypherVIPInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface ZypherVIP extends BaseContract {
  connect(runner?: ContractRunner | null): ZypherVIP;
  waitForDeployment(): Promise<this>;

  interface: ZypherVIPInterface;
