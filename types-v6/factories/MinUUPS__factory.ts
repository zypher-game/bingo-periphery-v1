...
export class MinUUPS__factory {
  ...
  static createInterface(): MinUUPSInterface {
    return new Interface(_abi) as MinUUPSInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): MinUUPS {
    return new Contract(address, _abi, runner) as unknown as MinUUPS;
  }
}
